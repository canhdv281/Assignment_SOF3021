...
<div class="row">
    <div class="col-3"></div>
    <div class="col-6">
        <p class="fs-2" style="color: red; text-align: center; font-weight: bold">QUẢN LÝ SẢN PHẨM</p>
...
<div class="row">
    ...
    <div class="col-6">
        <table class="table">
            ...
            <tbody>
            <c:forEach items="${ listSanPham.content }" varStatus="status" var="sp">
                <tr>
                    ...
                    <td>
                        ...
                        <a href="/san-pham/remove/${ sp.id }" class="btn btn-danger" onclick="return confirm('Bạn có muốn xóa không ?')">Remove</a>
                    </td>
                </tr>
            </c:forEach>
            </tbody>
        ...
        <nav aria-label="Page navigation example">
            <ul class="pagination">
                <c:forEach begin="0" end="${ listSanPham.totalPages - 1}" var="page">
                    <li class="page-item"><a class="page-link"
                                             href="/san-pham/hien-thi?page=${ page }">${ page + 1 }</a></li>
                </c:forEach>
            </ul>
        </nav>
    </div>
